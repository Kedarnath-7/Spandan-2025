    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      <section className="relative z-10 pt-24 pb-8">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="mb-8">
            <h1 className="text-8xl md:text-9xl font-black text-white mb-6 tracking-wider transform hover:scale-105 transition-transform duration-500 select-none">
              SPANDAN
            </h1>
            <div className="text-2xl md:text-3xl font-bold text-blue-400 mb-2 tracking-wide">
              EXCELSIOR: The Comic Chronicles
            </div>
            <div className="text-3xl md:text-4xl font-bold text-blue-300 mb-8 tracking-wider">
              25TH TO 30TH AUGUST
            </div>
          </div>

          {/* Description text - matching design typography */}
          <div className="max-w-5xl mx-auto space-y-6 text-gray-200 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="bg-cyan-500/20 border-2 border-cyan-400 backdrop-blur-sm hover:bg-cyan-500/30 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2 tracking-wide">DATES</h3>
                <p className="text-cyan-300 text-lg font-medium">Aug 25-30, 2025</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-700/50 border-2 border-slate-500 backdrop-blur-sm hover:bg-slate-700/70 transition-all duration-300 transform hover:scale-105">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-2 tracking-wide">VENUE</h3>
                <p className="text-gray-300 text-lg font-medium">JIPMER Pondicherry</p>
              </CardContent>
            </Card>
